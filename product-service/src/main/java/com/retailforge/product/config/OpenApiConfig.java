package com.retailforge.product.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
            ...
            .info(new Info()
                .title("RetailForge Product Service API")
                .version("1.0.0")
                .description("Microservice REST API documentation for managing product items and categories in RetailForge."))
