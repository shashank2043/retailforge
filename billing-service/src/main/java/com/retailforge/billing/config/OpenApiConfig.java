package com.retailforge.billing.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
            ...
            .info(new Info()
                .title("RetailForge Billing Service API")
                .version("1.0.0")
                .description("Microservice REST API documentation for managing retail checkouts, orders, and PDF invoice generation in RetailForge."))
